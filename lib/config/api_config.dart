...
class ApiConfig {
  // Base URLs — IP and port are read from AppConfig (constants.dart).
  // To change the server IP, update AppConfig.serverHost in constants.dart.
  ...
  static String get baseUrl => isProduction
      ? _productionBaseUrl
      : 'http://${AppConfig.serverHost}:${AppConfig.serverPort}/api';
